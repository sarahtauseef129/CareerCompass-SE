...
import { GitCompareArrows, Map } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-24 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-md mx-auto">
          ...
          <p className="text-muted-foreground mb-8">Take the career assessment to discover your top 5 career matches based on your interests, skills, and preferences.</p>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-12">
        ...
        <p className="text-sm text-muted-foreground text-center mb-6">
          Click cards to view details. Select up to 3 to compare. View a roadmap to start tracking your learning.
        </p>

        {/* Career cards – Top 5 only */}
            ...
            >
              <div className="relative">
                <div
                  ...
                  onClick={(e) => { e.stopPropagation(); toggleCompare(r.career.id); }}
                >
                  {compareList.includes(r.career.id) ? "✓" : i + 1}
                </div>
                <CareerCard career={r.career} score={r.finalScore} missingSkills={r.missingSkills} />
                <div className="mt-2">
                  <Button
                    variant="outline"
                    size="sm"
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      navigate(`/roadmap?career=${r.career.id}`);
                    }}
                  >
